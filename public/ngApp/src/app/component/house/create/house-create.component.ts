...
export class RepoBrowserComponent {
   ...
   */
  public constructor(private router: Router, private github: GithubService, private httpService: HttpService, viewContainerRef: ViewContainerRef) {
  ...
  searchForOrg(orgName: string) {
    this.github.getOrg(orgName)
      .subscribe(({name}) => {
        console.log(name);
        this.router.navigate(['/house', orgName]);
      });
  }
